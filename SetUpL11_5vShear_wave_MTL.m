...
P.endDepth = 180;   % This should preferrably be a multiple of 128 samples.
...
Resource.RcvBuffer(1).rowsPerFrame=2400*m*2;
...
Resource.RcvBuffer(2).rowsPerFrame = ne*2400*2;
